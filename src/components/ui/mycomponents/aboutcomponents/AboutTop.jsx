    ...
    <section className="py-8 lg:py-24">
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
            <div className="flex md:flex-1">
                <Image src="/about.jpg" alt="working on housing" width={1300} height={900} className="w-full md:h-full object-cover rounded-lg" />
            </div>
            <div className="md:w-1/2 lg:w-[54%] space-y-12 text-gray-700 dark:text-gray-300">
                ...
                Your Trusted Car Mechanics in Amritsar
                </h1>
                <p>
                We’re not just another car repair shop—we’re your go-to experts for everything automotive. With years of experience, advanced tools, and a commitment to quality, we keep your vehicle in peak condition.
                </p>
                <div className="grid sm:grid-cols-2 gap-6">
                    <div className="space-y-6 p-4 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-900">
                        ...
                        <p>
                        Provide top-notch auto services at honest prices.
                        </p>
                    </div>
                    <div className="space-y-6 p-4 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-900">
                        <span className="rounded-full bg-gray-900 dark:bg-gray-100 text-gray-100 dark:text-gray-900 w-max p-3 flex">
                        ...
                        <p>
                        Reliable repairs with complete transparency.
                        </p>
                    </div>
                </div>
            </div>
